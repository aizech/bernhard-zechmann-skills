...
class TestRelevanceScore(unittest.TestCase):
    def test_perfect_match(self) -> None:
        score = relevance_score(
            "python tutorial", "Python Tutorial", "Learn Python tutorial basics"
        )
        self.assertGreater(score, 0.8)

    def test_no_match(self) -> None:
        score = relevance_score(
            "python tutorial", "Cat Videos", "Funny animal compilation"
        )
        self.assertLess(score, 0.1)

    def test_partial_match(self) -> None:
        score = relevance_score(
            "python tutorial", "Python Guide", "A comprehensive guide"
        )
...
class TestDeduplicate(unittest.TestCase):
    ...
    def test_title_similarity_dedup(self) -> None:
        results = [
            ...
            {
                "title": "Python Tutorial for Beginners Guide",
                "url": "https://b.com/2",
                "snippet": "s2",
            },
        ]
