...
class TestHealthTracker(unittest.TestCase):
    ...
    def test_record_and_load(self) -> None:
        ...
        self.tracker.record(
            "brave", success=False, latency_ms=5000, error_type="NetworkError"
        )
    ...
    def test_summary(self) -> None:
        ...
        self.tracker.record(
            "tavily", success=False, latency_ms=5000, error_type="AuthError"
        )
    ...
    def test_smart_order_with_sufficient_data(self) -> None:
        ...
        for _ in range(3):
            self.tracker.record(
                "brave", success=False, latency_ms=4000, error_type="NetworkError"
            )
